...
//                audiomanager.set
    ...
    public void checkPermission(String permission, int requestCode) {
        if (ContextCompat.checkSelfPermission(ContactActivity.this, permission) == PackageManager.PERMISSION_DENIED) {

            // Requesting the permission
            ActivityCompat.requestPermissions(ContactActivity.this, new String[]{permission}, requestCode);
        } else {
            Toast.makeText(ContactActivity.this, "Permission already granted", Toast.LENGTH_SHORT).show();
        }
    }
